...
// extern void imdct_step3_iter0_loop(int n, float *e, int i_off, int k_off, float *A);
// extern void imdct_step3_inner_r_loop(int lim, float *e, int d0, int k_off, float *A, int k1);
// extern void imdct_step3_inner_s_loop(int n, float *e, int i_off, int k_off, float *A, int a_off, int k0);
extern void inverse_mdct(float *buffer, int n, vorb *f, int blocktype);
